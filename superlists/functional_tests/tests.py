...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test__new_visitor_can_start_a_list_and_retrieve_it_later(self):
    ...
    def test__multiple_users_can_start_lists_at_different_urls(self):
        ...
        self.assertNotEqual(francis_list_url, ediths_list_url)
